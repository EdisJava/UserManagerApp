...
Q_CONSTINIT const QMetaObject DptoForm::staticMetaObject = { {
    ...
    qt_incomplete_metaTypeArray<qt_meta_tag_ZN8DptoFormE_t,
        ...
        QtPrivate::TypeAndForceComplete<void, std::false_type>,
        // method 'on_btnAsignarUsr_clicked'
        QtPrivate::TypeAndForceComplete<void, std::false_type>
    >,
    nullptr
} };
...
void DptoForm::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->departamentoGuardado((*reinterpret_cast< std::add_pointer_t<QString>>(_a[1]))); break;
        case 1: _t->on_btnCrear_clicked(); break;
        case 2: _t->on_btnBorrar_clicked(); break;
        case 3: _t->on_btnEditar_clicked(); break;
        case 4: _t->on_btnAsignarUsr_clicked(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (DptoForm::*)(const QString & );
            if (_q_method_type _q_method = &DptoForm::departamentoGuardado; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void DptoForm::departamentoGuardado(const QString & _t1)
{
